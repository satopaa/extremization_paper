...
Consulting experts are often asked to report their beliefs on various estimation problems. If the experts form their estimates independently of each
...
\begin{minipage}[t]{.5\textwidth}
	\hspace{0em}\includegraphics{LegendMarginal} % requires the graphicx package
 \includegraphics[width= 0.85\textwidth]{Marginals}
