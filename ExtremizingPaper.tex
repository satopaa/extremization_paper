...
\begin{itemize}
\item The amount of extremizing establishes a spectrum from full information overlap/no extremization to no information overlap/full extremization. The two extremes require different aggregation techniques. In particular, average aggregates work well under high information overlap and more extreme aggregates such as voting work well under low information overlap,
\item The modal amount of extremizing is increasing in the level of information diversity and the total amount of information among experts, and
