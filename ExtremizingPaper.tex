...
expected from an aggregator that is based on a model that does not explicitly link the observations and the correct quantity
of interest.
...
adjustments. In some cases the direction of the bias can be
determined. For instance, \citet{Ranjan08} prove that any convex
combination of calibrated forecasts is under-confident, i.e.,
too close to $0.5$. This applies to the averaging aggregators that are by nature different convex combinations of the
forecasts.
...
unrealistic structure on interpreted forecasts. Any transformed average is also constrained to
the convex hull of the individual forecasts, hence further contradicting the
