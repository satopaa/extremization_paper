...
%\end{eqnarray*}
%%
%%$\boldsymbol{P} \sim \mathcal{N}_N\left(\boldsymbol{0}, {\bf\Sigma}_{22} (1-\delta)^{-1}\right)$ and that
...
%%&=& \frac{(1-\delta)^{N/2}}{\sqrt{ |{\bf\Sigma}_{22}|}} \exp\left( -\frac{1}{2} \boldsymbol{P}' (1-\delta){\bf\Sigma}_{22}^{-1} \boldsymbol{P} + \frac{\boldsymbol{P}' \boldsymbol{P}}{2}   \right)\\
...
%&=& \frac{(1-\delta)^{N/2}}{\sqrt{ \left|{\bf\Sigma}_{22}\right|}} \exp\left[ -\frac{1}{2} \Phi^{-1}(\boldsymbol{p})' \left\{ (1-\delta) {\bf\Sigma}_{22}^{-1} - {\bf I}_N \right\} \Phi^{-1}(\boldsymbol{p})  \right],
\end{eqnarray*}
...
%Given that ${\bf\Sigma}_{22}$ can be written in the form  ${\bf\Sigma}_{22} = B_N (\delta-\lambda\delta) + J_{N \times N} \lambda\delta$
%where
%%The determinant and inverse of ${\bf\Sigma}_{22}$ are
%\begin{align*}
%\left| {\bf\Sigma}_{22}\right| &= (\delta(1- \lambda))^N \left(1+\frac{N \lambda}{1 - \lambda} \right) \nonumber\\
%{\bf\Sigma}_{22}^{-1} &= {\bf I}_N \left(\frac{1}{\delta-\lambda\delta} \right) - J_{N \times N} \frac{\lambda}{(1-\lambda)\delta\{1+(N-1) \lambda\}} 
%\end{align*}
%See \citet{rao2009linear} and the supplementary material of \citet{dobbin2005sample} for the derivations of the determinant and inverse of ${\bf\Sigma}_{22}$, respectively. The maximum likelihood estimates of $\delta$ and $\lambda$ are then obtained from
%\begin{align*}
