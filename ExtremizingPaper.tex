...
The next step is
to link the pool of information with the probability forecasts. Note that conditional on the $i$th Forecaster's information, $X_S | X_{B_i} \sim \mathcal{N}\left(X_{B_i}, 1-\delta_j\right)$. Thus,
\begin{align*}
...
pool was chosen for the analysis because a) $\probit$ is arguably more
...
\citealt{parunak2013characterizing} for a discussion on voting-like techniques). This spectrum is particularly visible in the next section
